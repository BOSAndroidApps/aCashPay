...
import com.bos.payment.appName.databinding.ActivityVpatransactionReportsBinding
import com.bos.payment.appName.network.RetrofitClient
import com.bos.payment.appName.ui.adapter.TransactionReportAdapter
import com.bos.payment.appName.ui.adapter.VPATransactionReportAdapter
...
class VPATransactionReports : AppCompatActivity() {
    private lateinit var binding: ActivityVpatransactionReportsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityVpatransactionReportsBinding.inflate(layoutInflater)
    ...
    private fun hitApiForGettingTransactionReports(){
        runIfConnected {
            val reportReq = VPATransactionReq(
                endDate = ToDate,
            ...
            getAllApiServiceViewModel.vpaTransactionReq(reportReq)
